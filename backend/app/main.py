...
def create_app(database_url: str | None = None, *, create_tables: bool = True, explanation_provider: ExplanationProvider | None = None, voice_provider: VoiceProvider | None = None) -> FastAPI:
    ...
    if database_url is not None:
        settings = AppSettings(
            ...
            exotel_app_id=settings.exotel_app_id,
            ...
            vobiz_auth_id=settings.vobiz_auth_id,
            vobiz_auth_token=settings.vobiz_auth_token,
            vobiz_caller_id=settings.vobiz_caller_id,
            vobiz_api_base_url=settings.vobiz_api_base_url,
            vobiz_stream_url=settings.vobiz_stream_url,
