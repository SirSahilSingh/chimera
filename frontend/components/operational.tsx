...
import { ArrowRightIcon, CheckIcon, ClockIcon, ShieldIcon, AlertIcon, ExternalIcon } from "./icons";
...
import type { Candidate, Decision, Execution, RecoveryCase } from "../lib/types";
